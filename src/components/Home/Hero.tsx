...
import { Play, Award, Users, Clock, Heart, X } from "lucide-react"
...
const Hero = () => {
  ...
  const videoUrl = "https://www.youtube.com/embed/C10e-_VSm3E?autoplay=1"
  ...
  return (
    <section className={styles.hero}>
      ...
      {/* Video Popup - OUTSIDE the slides loop */}
      {isVideoOpen && (

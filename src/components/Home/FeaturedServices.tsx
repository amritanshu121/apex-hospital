...
import { Heart, Brain, Bone, Stethoscope, FlaskConical } from "lucide-react"
...
const services: ServiceCard[] = [
  ...
  },
  {
    ...
    description: "Gastroenterology deals with the diagnosis and treatment of digestive system disorder.",
    icon: <FlaskConical size={28} />,
    href: "/specialities/gastroenterology",
    img: "/images/gastro.jpg",
    bg: styles.ortho,
  },
  {
    name: "Obstetrics & Gynecology",
    description: "Obstetrics and Gynecology deals with womens reproductive health and pregnancy care.",
  ...
  },
  {
    ...
    description: "Plastic surgery is a medical procedure to restore, enhance, or alter the appearance and function of body ",
    icon: <Stethoscope size={28} />,
    href: "/specialities/plastic-surgery",
    img: "/images/plasticsurgery.jpg",
    bg: styles.ortho,
  },
]

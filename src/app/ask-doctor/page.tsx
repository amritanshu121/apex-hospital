...
export default function AskDoctorPage() {
  const faqItems = [
    ...
    },
    {
      ...
      answer: "You can ask general health questions, information about common conditions, or advice on preventive care. For personalized diagnoses or treatment plans, please consult a doctor directly.",
    },
    {
      question: "Who are the doctors answering the questions?",
      answer: "Our team consists of licensed medical professionals with various specializations, ensuring you receive reliable information.",
    },
  ]
